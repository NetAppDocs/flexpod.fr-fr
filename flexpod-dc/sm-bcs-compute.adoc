...
image:sm-bcs-image17.png["Un schéma montrant les UCS 2204XP A et B connectés à un B200 M5 VIC via 10GBASE-KR"]
...
image:sm-bcs-image18.png["Un schéma montrant les modules d'E/S UCS 5108 connectés aux commutateurs FI 6454 et aux commutateurs Nexus A et B"]
...
image:sm-bcs-image19.png["Capture d'écran montrant la boîte de dialogue « Définir les paramètres de démarrage iSCSI » de Cisco UCS Manager avec deux cibles statiques configurées"]
