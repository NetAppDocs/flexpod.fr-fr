...
image:sm-bcs-image22.png["Un schéma montrant un AFF A250 connecté aux commutateurs Nexus A et Nexus B sur deux sites"]
...
image:sm-bcs-image23.png["Un schéma illustrant les ports du contrôleur AFF A250 connectés à Nexus, les groupes d'interfaces, les ports VLAN et les LIF"]
...
image:sm-bcs-image24.png["Un schéma illustrant la connectivité de démarrage SAN iSCSI redondante entre les serveurs B200 M5 et les contrôleurs AFF A250"]
...
image:sm-bcs-image25.png["Capture d'écran de la boîte de dialogue « Ajouter des interfaces inter-clusters » d'ONTAP System Manager avec deux champs d'adresse IP"]
...
+
image:sm-bcs-image26.png["Capture d'écran de la boîte de dialogue « Générer une phrase secrète » avec les autorisations entre cluster, la validité et une phrase secrète copiée"]

. Appeler l'option Peer Cluster dans le second cluster et fournir la phrase de passe et les informations LIF intercluster
+
image:sm-bcs-image27.png["Capture d'écran montrant la boîte de dialogue Peer Cluster de l'ONTAP System Manager avec la phrase secrète et les adresses LIF intercluster"]

. Le volet protection > Présentation de System Manager affiche les informations sur les pairs de cluster.
+
image:sm-bcs-image28.png["Capture d'écran de la vue d'ensemble de la protection d'ONTAP System Manager montrant l'état de l'entre cluster et du médiateur"]
...
image:sm-bcs-image29.png["Capture d'écran de la boîte de dialogue Configurer le médiateur dans ONTAP System Manager avec les champs de connexion du médiateur"]
...
image:sm-bcs-image30.png["Capture d'écran du volet Vue d'ensemble de la protection d'ONTAP System Manager affichant l'état du médiateur configuré"]
...
image:sm-bcs-image31.png["Capture d'écran de la boîte de dialogue « Protéger le groupe de cohérence » avec le volume source esxi_a et le cluster de destination aff-a250-b"]
...
image:sm-bcs-image32.png["Capture d'écran de ONTAP System Manager montrant deux groupes de cohérence sains et synchronisés sur le site A"]

Cette capture d'écran affiche les relations de groupe de cohérence sur le site B.

image:sm-bcs-image33.png["Capture d'écran des relations dans ONTAP System Manager sur le site B montrant deux groupes de cohérence sains et synchronisés"]

Cette capture d'écran affiche les détails de la relation de groupe de cohérence pour le groupe cg_infra_datastore_b.

image:sm-bcs-image34.png["Capture d'écran de ONTAP System Manager affichant les détails de la relation du groupe de cohérence cg_infra_datastore_b"]
...
image:sm-bcs-image35.png["Capture d'écran des informations de volume ONTAP pour Infra-SVM-a, incluant les volumes RW, DP et LS"]

Cette capture d'écran affiche les informations de volume du site B.

image:sm-bcs-image36.png["Une capture d'écran de la sortie de la commande ONTAP volume show pour Infra-SVM-b, listant neuf volumes, y compris les volumes DP de destination"]
...
image:sm-bcs-image37.png["Capture d'écran montrant les igroups iSCSI et les mappages de LUN du site A dans la sortie de l'interface de ligne de commande ONTAP"]

Cette capture d'écran montre les groupes initiateurs hôtes et le mappage de LUN pour le cluster du site B.

image:sm-bcs-image38.png["Capture d'écran du résultat de la commande de mappage igroup et LUN du site B pour les hôtes VMware iSCSI"]
