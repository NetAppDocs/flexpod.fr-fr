...
image:sm-bcs-image2.png["Un schéma illustrant les composants FlexPod du centre de données : Cisco UCS, commutateurs Nexus/MDS et stockage NetApp AFF/FAS/ASA"]
...
image:sm-bcs-image3.png["Un schéma illustrant la réplication synchrone SnapMirror et le basculement automatique entre les centres de données principal et secondaire"]
