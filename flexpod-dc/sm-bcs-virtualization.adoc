...
image:sm-bcs-image39.png["Un schéma illustrant VMware HA et vSphere Metro Storage Cluster sur FlexPod sites A et B via une infrastructure multisite"]
...
image:sm-bcs-image40.png["Un schéma montrant les serveurs Cisco UCS B200 M5 et le stockage AFF A250 aux sites A et B, connectés via des commutateurs Nexus et un ONTAP Mediator au site C"]
...
image:sm-bcs-image41.png["Un schéma illustrant les commutateurs vSwitch0, vDS0, iSCSI-A et iSCSI-B avec six liaisons montantes vNIC"]
...
image:sm-bcs-image42.png["Capture d'écran montrant les groupes de machines virtuelles/hôtes pour les hôtes et les machines virtuelles des sites A et B dans vSphere"]
...
image:sm-bcs-image43.png["Capture d'écran de la boîte de dialogue Modifier la règle VM/hôte configurant les machines virtuelles du site A pour s'exécuter sur les hôtes du site A"]

image:sm-bcs-image44.png["Capture d'écran de la boîte de dialogue Modifier la règle de VM/hôte pour les VM et les hôtes du site B avec l'option « Devrait s'exécuter sur les hôtes du groupe » dans la stratégie de groupe"]
...
image:sm-bcs-image45.png["Capture d'écran des options avancées de haute disponibilité vSphere avec quatre banques de données de pulsation et deux adresses d'isolation configurées"]
...
image:sm-bcs-image46.png["Capture d'écran des paramètres vSphere HA Heartbeat Datastores avec quatre banques de données spécifiées sélectionnées"]

Pour plus de bonnes pratiques et de configurations pour VMware HA Cluster et VMware vSphere Metro storage cluster, voir  https://docs.vmware.com/en/VMware-vSphere/7.0/com.vmware.vsphere.avail.doc/GUID-5432CA24-14F1-44E3-87FB-61D937831CF6.html["Création et utilisation de clusters HA vSphere"^], https://core.vmware.com/resource/vmware-vsphere-metro-storage-cluster-vmsc["Cluster de stockage Metro VMware vSphere (vMSC)"^] et  https://docs.netapp.com/us-en/netapp-solutions-virtualization/vmware/vmw-vmsc-with-smas.html["NetApp ONTAP avec SnapMirror active sync (anciennement SM-BC) et VMware vSphere Metro Storage Cluster (vMSC)"^].
