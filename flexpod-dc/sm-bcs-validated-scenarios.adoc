...
image:sm-bcs-image47.png["Un diagramme illustrant les chemins iSCSI ESXi à travers deux fabrics vers les LUN du groupe de cohérence principal et de destination"]
...
image:sm-bcs-image48.png["Capture d'écran de l'onglet Chemins des adaptateurs de stockage ESXi montrant deux chemins actifs (I/O) et six chemins iSCSI actifs"]
...
image:sm-bcs-image49.png["Capture d'écran du vSphere Client montrant six banques de données iSCSI montées sur l'hôte esxi-a-01.nva.local"]
...
image:sm-bcs-image50.png["Capture d'écran de vSphere de la sélection du stockage de migration pour iometer-a-01 avec des banques de données iSCSI provenant des sites A et B"]
...
+
image:sm-bcs-image51.png["Capture d'écran de ONTAP System Manager Relationships avec le menu des options de la source affichant Failover"]

. Confirmer le basculement pour que l'action démarre.
+
image:sm-bcs-image52.png["Capture d'écran de la confirmation de basculement planifié d'ONTAP System Manager pour cg_esxi_a de Infra-SVM.1 vers Infra-SVM-b"]
...
image:sm-bcs-image53.png["Capture d'écran d'ONTAP System Manager montrant les graphiques de performance du site A avec une réduction des IOPS et du débit"]
...
image:sm-bcs-image54.png["Capture d'écran du tableau de bord ONTAP System Manager affichant des performances de 132,99 K IOPS et un débit de 1 038,58 Mo/s"]
...
image:sm-bcs-image55.png["Capture d'écran d'ONTAP System Manager Relationships montrant des groupes de cohérence sains, synchronisés et une option de menu Failover"]
...
image:sm-bcs-image56.png["Un diagramme montrant que le stockage du site A est indisponible et que les services de données SM-BC continuent sur le site B via ONTAP Mediator"]
...
image:sm-bcs-image57.png["Capture d'écran du tableau de bord ONTAP System Manager affichant 80,32k IOPS et un débit de 626,98 Mo/s"]

image:sm-bcs-image58.png["Capture d'écran du tableau de bord ONTAP System Manager pour aff-a250-b affichant 81,37 k IOPS et un débit de 635,41 Mo/s"]
...
image:sm-bcs-image59.png["Capture d'écran d'ONTAP System Manager montrant une nette augmentation des performances IOPS et du débit sur le cluster aff-a250-b"]
...
image:sm-bcs-image60.png["Capture d'écran de ONTAP System Manager montrant deux relations saines désynchronisées"]
...
image:sm-bcs-image61.png["Capture d'écran montrant les relations d'ONTAP System Manager avec un état sain et synchronisé"]
...
image:sm-bcs-image62.png["Capture d'écran de la boîte de dialogue Modifier la règle VM/hôte attribuant les VM du site A au groupe d'hôtes du site B"]
...
image:sm-bcs-image63.png["Capture d'écran de deux fenêtres BMC CLI affichant les commandes d'arrêt système pour aff-a250-a-01 et aff-a250-a-02"]
...
image:sm-bcs-image64.png["Capture d'écran d'un tableau de bord Grafana affichant les métriques de latence, de débit et d'IOPS du SVM pour Infra-SVM sur le cluster aff-a250-a"]

image:sm-bcs-image65.png["Capture d'écran du tableau de bord Grafana SVM affichant les graphiques de latence, de débit et d'IOPS pour Infra-SVM-b"]
...
image:sm-bcs-image66.png["Capture d'écran des options de génération TPROC-C de Microsoft SQL Server avec 100 entrepôts et 10 utilisateurs virtuels"]
...
image:sm-bcs-image67.png["Capture d'écran du compteur de transactions HammerDB montrant une brève baisse puis une reprise des transactions lors de la création de TPROC-C"]
...
image:sm-bcs-image68.png["Capture d'écran du tableau de bord Grafana de NAbox montrant que la latence, le débit et les IOPS du cluster de stockage du site B tombent à zéro"]
...
image:sm-bcs-image69.png["Capture d'écran du tableau de bord Grafana de NAbox affichant les métriques de latence, de débit et d'IOPS du SVM du site A"]
