...
image:sm-bcs-image16.png["Un diagramme montrant les sites FlexPod A et B liés par des relations étendues de couche 2 et SM-BC avec ONTAP Mediator au site C"]
