...
image:sm-bcs-image4.png["Un schéma montrant les sites FlexPod A et B connectés avec une latence maximale de 10 ms et un ONTAP Mediator sur le site C"]
...
image:sm-bcs-image5.png["Un schéma illustrant les serveurs Cisco UCS C240/C245, C220/C225, B200 et X210c M6"]
...
image:sm-bcs-image6.png["Un schéma montrant les vues de face des modules UCS 2408, 2304, 2208XP, 2204XP et UCSX 9108"]
...
image:sm-bcs-image7.png["Un schéma illustrant les panneaux avant des modèles Cisco UCS FI 6454, 64108, 6324, 6332 et 6332-16UP"]
...
image:sm-bcs-image8.png["Un schéma montrant les cartes pont Cisco UCS VIC 1440, 1467, 1455, 1480, 1477, 1457, 14825, 14425 et 14000"]
...
image:sm-bcs-image9.png["Un schéma illustrant les commutateurs Cisco Nexus 9336C-FX2, 93180YC-FX3 et 3232C"]
...
image:sm-bcs-image10.png["Un schéma présentant les vues de face des commutateurs Cisco MDS 9132T, 9148T, 9148S, 9250i et 9396T"]
...
image:sm-bcs-image11.png["Un schéma qui montre les contrôleurs NetApp AFF et ASA ainsi que les baies de disques DS 224C/2246 et NS 224"]
...
image:sm-bcs-image12.png["Un diagramme illustrant deux FlexPod sites avec des relations SM-BC et un ONTAP Mediator sur le site C"]
...
image:sm-bcs-image13.png["Un diagramme qui montre des sites FlexPod asymétriques connectés par des liaisons étendues de couche 2 et ONTAP Mediator"]
...
image:sm-bcs-image14.png["Un diagramme illustrant les sites FlexPod gérés par Intersight et UCSM connectés via une infrastructure multisite VXLAN avec des relations SM-BC"]
...
image:sm-bcs-image15.png["Un schéma illustrant les sites distants FlexPod connectés à un centre de données via une infrastructure VXLAN multisite et ONTAP Mediator"]
