...
image:sm-bcs-image20.png["Un schéma illustrant la connectivité locale redondante des FI 6454, Nexus et AFF A250"]
...
image:sm-bcs-image21.png["Un diagramme illustrant les liaisons homologues vPC et les liaisons intersites entre les commutateurs FlexPod des sites A et B"]
