...
image:cloud-fabricpool_image10.png["Un diagramme qui montre les configurations valides et invalides de liaison agrégat-vers-compartiment FabricPool"]
...
+
image:cloud-fabricpool_image11.png["Capture d'écran de la recherche dans la console AWS montrant le résultat « Stockage évolutif S3 dans le cloud » mis en évidence"]
...
+
image:cloud-fabricpool_image12.png["Capture d'écran de la boîte de dialogue AWS « Créer un compartiment » avec le nom du compartiment, la région et le bouton « Créer »"]
