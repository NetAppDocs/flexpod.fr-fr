...
image:cloud-insights_image2.png["Un schéma montrant Cisco UCS, les commutateurs Nexus, les contrôleurs NetApp AFF A800 et les commutateurs MDS interconnectés par des liaisons réseau"]
...
* Analyse de l'environnement à l'aide des données fournies à NetApp Digital Advisor pour l'évaluation des risques liés au système de stockage et les recommandations d'optimisation du stockage.
