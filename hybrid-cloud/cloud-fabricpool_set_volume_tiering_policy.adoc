...
+
image:cloud-fabricpool_image16.png["Une capture d'écran qui montre la boîte de dialogue « Modifier la stratégie de hiérarchisation des volumes » avec les options de stratégie de hiérarchisation développées"]
