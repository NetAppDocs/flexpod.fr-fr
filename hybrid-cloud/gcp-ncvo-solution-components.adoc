...
Vous trouverez plus d'informations sur les licences Intersight et les fonctionnalités prises en charge dans chaque licence https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["ici"^].
...
Après avoir intégré Intersight Assist à Intersight, vous pouvez revendiquer des périphériques terminaux à l'aide de l'option « Revendiquer via Intersight Assist ». Pour plus d'informations, consultez https://intersight.com/help/saas/getting_started/overview["Mise en route"^].
