...
NOTE: Veuillez vous référer à  https://hwu.netapp.com/DetailViews/Home.aspx[][NetApp Hardware Universe^] pour obtenir les dernières informations sur les plateformes prises en charge avec FabricPool.

* NetApp ONTAP Select [REMARQUE] NetApp recommande d'utiliser des niveaux locaux FabricPool entièrement SSD.
* Tiers cloud
+
