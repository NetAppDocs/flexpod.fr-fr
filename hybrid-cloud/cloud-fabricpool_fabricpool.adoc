...
image:cloud-fabricpool_image4.png["Un diagramme illustrant le stockage hiérarchisé basé uniquement sur les instantanés, déplaçant les copies d'instantanés d'un cluster principal vers le stockage cloud"]
...
image:cloud-fabricpool_image5.png["Un diagramme illustrant le déplacement automatique des données inactives du stockage du cluster principal vers le stockage cloud"]
