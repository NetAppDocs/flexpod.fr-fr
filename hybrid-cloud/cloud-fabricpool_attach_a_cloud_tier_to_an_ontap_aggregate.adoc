...
+
image:cloud-fabricpool_image14.png["Capture d'écran montrant le menu de navigation OnCommand System Manager avec Applications  Tiers sélectionnés"]

. Cliquez sur niveaux de stockage.
. Cliquer sur un agrégat.
. Cliquez sur actions et sélectionnez attacher Cloud Tier.
+
image:cloud-fabricpool_image15.png["Capture d'écran montrant le menu Plus d'actions avec l'option Attacher un niveau cloud sélectionnée"]
