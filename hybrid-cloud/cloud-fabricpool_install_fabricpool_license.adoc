...
image:cloud-fabricpool_image8.png["Capture d'écran de la boîte de dialogue OnCommand System Manager « Ajouter des packages de licences » avec les boutons « Choisir des fichiers » et « Ajouter »"]
...
image:cloud-fabricpool_image9.png["Capture d'écran des détails des licences ONTAP System Manager montrant une capacité de licence FabricPool de 10 To et une capacité actuelle de 0 octet"]
