...
https://github.com/ucs-compute-solutions/cvo_snapmirror["Lien GitHub"^] fournit la configuration Terraform avec diverses ressources. Vous pouvez forker ce dépôt et en faire une copie dans votre compte GitHub.
