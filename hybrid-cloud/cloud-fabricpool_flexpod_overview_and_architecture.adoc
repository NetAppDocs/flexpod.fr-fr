...
image:cloud-fabricpool_image2.png["Un schéma présentant le stockage FlexPod, les commutateurs Cisco Nexus et MDS, ainsi que les familles Cisco UCS avec des indications de connectivité"]
...
image:cloud-fabricpool_image3.png["Un schéma illustrant les connexions Cisco UCS, Nexus 93180YC-EX, AFF A300 et MDS 9148S"]
