...
. Allez à https://www.netapp.com/data-infrastructure-insights/["https://www.netapp.com/data-infrastructure-insights/"^]
...
+
image:cloud-insights_image3.png["Un menu contextuel vSphere avec « Nouvelle machine virtuelle » mis en évidence parmi les actions du cluster"]
...
+
image:cloud-insights_image4.png["Capture d'écran de l'assistant de sélection du système d'exploitation invité avec Linux et Red Hat Enterprise Linux 7 (64-bit) sélectionnés"]
...
+
image:cloud-insights_image5.png["Capture d'écran de VMware : personnalisation des paramètres matériels avec le processeur, la mémoire, le disque, le réseau et le lecteur CD/DVD configurés"]
...
+
image:cloud-insights_image6.png["Capture d'écran du menu de démarrage Red Hat Enterprise Linux 7.6 avec l'option « Installer » sélectionnée"]
...
+
image:cloud-insights_image7.png["Capture d'écran montrant un disque virtuel VMware de 100 Gio sélectionné et l'option de partitionnement manuel"]
...
+
image:cloud-insights_image8.png["Capture d'écran du partitionnement manuel de Red Hat Enterprise Linux avec des volumes de 25 Gio /opt/netapp et /var/log/netapp"]
...
+
image:cloud-insights_image9.png["Capture d'écran de l'écran Réseau et nom d'hôte de Red Hat Enterprise Linux avec Ethernet activé et un nom de l'hôte saisi"]
...
+
image:cloud-insights_image10.png["Capture d'écran de l'écran de fin d'installation de Red Hat Enterprise Linux avec un bouton Reboot"]

. Une fois le système redémarré, connectez-vous à votre serveur et enregistrez-le à l'aide de Red Hat Subscription Manager.
+
image:cloud-insights_image11.png["Un terminal affichant l'enregistrement réussi de Red Hat Subscription Manager pour le système Netapp-AU"]

. Joignez un abonnement disponible à Red Hat Enterprise Linux.
+
image:cloud-insights_image12.png["Un terminal affichant la connexion réussie d'un abonnement Red Hat Enterprise Linux"]
...
+
image:cloud-insights_image14.png["Capture d'écran montrant les onglets Collecteurs de données et Unités d'acquisition, avec l'onglet Unités d'acquisition sélectionné"]

. Pour créer une nouvelle unité d'acquisition, cliquez sur le bouton à droite.
+
image:cloud-insights_image15.png["Une capture d'écran qui montre le bouton Ajouter une unité d'acquisition et un champ Filtre"]
...
+
image:cloud-insights_image16.png["Capture d'écran montrant les instructions d'installation de Cloud Insights Linux Acquisition Unit et un extrait du programme d'installation"]

. Collez le fragment dans la CLI de la machine Red Hat Enterprise Linux qui a été provisionnée, puis cliquez sur entrée.
+
image:cloud-insights_image17.png["Une fenêtre de terminal affichant une commande de jeton pour installer l'unité d'acquisition Cloud Insights sur Linux"]
...
+
image:cloud-insights_image18.png["Un terminal affichant l'installation et l'enregistrement réussis de l'unité d'acquisition NetApp Cloud Insights"]
...
+
image:cloud-insights_image19.png["Capture d'écran du résumé de l'unité d'acquisition NetApp-AU affichant l'adresse IP, le statut OK et la dernière heure signalée"]
...
+
image:cloud-insights_image20.png["Capture d'écran montrant les options de collecteur de données ONTAP filtrées sur la page Ajouter un collecteur de données"]
...
+
image:cloud-insights_image21.png["Capture d'écran de la page Configurer le collecteur avec des informations d'identification ONTAP validées et des paramètres de l'unité d'acquisition"]
...
+
image:cloud-insights_image22.png["Capture d'écran d'une ligne de collecteur de données Cloud Insights affichant l'état d'interrogation FlexPod Datacenter"]
