...
[role="lead"]
NetApp ONTAP est installé sur tous les systèmes NetApp FAS, AFF et ASA. FlexPod est validé avec le logiciel ONTAP, offrant une architecture de stockage hautement évolutive qui permet des opérations sans interruption, des mises à niveau sans interruption et une infrastructure de données agile.
