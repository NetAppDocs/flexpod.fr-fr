...
[role="lead"]
L’architecture FlexPod est définie par l’ensemble des règles décrites dans ce document. Les composants matériels et les configurations logicielles doivent être pris en charge par le  https://ucshcltool.cloudapps.cisco.com/public["Liste de compatibilité matérielle Cisco (HCL)"^] et le  http://mysupport.netapp.com/matrix["Matrice d'interopérabilité NetApp (IMT)"^].
