...
Pour plus d'informations sur les baies de disques et les supports de stockage, consultez le lien « Spécifications techniques des baies de disques et des supports de stockage » dans le tableau suivant.

|===
| Tiroir disque | Caractéristiques techniques 


| DS224C .4+| https://www.netapp.com/data-storage/disk-shelves-storage-media/["Spécifications techniques des étagères à disques et des supports de stockage"] 
