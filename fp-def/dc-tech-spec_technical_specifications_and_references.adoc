...
| NetApp AFF A800 | https://docs.netapp.com/us-en/ontap-systems/a800/install-setup.html["Documentation de la plateforme AFF A800"] 


| NetApp AFF A700 | https://docs.netapp.com/us-en/ontap-systems/a700/install-setup.html["Documentation sur la plateforme AFF A700"] 


| NetApp AFF A700s | https://docs.netapp.com/us-en/ontap-systems/a700s/install-setup.html["Documentation de la plateforme AFF A700s"] 


| NetApp AFF A400 | https://docs.netapp.com/us-en/ontap-systems/a400/install-setup.html["Documentation sur la plateforme AFF A400"] 


| NetApp AFF A250 | https://docs.netapp.com/us-en/ontap-systems/a250/install-setup.html["Documentation de la plateforme AFF A250"] 
|===
...
Les spécifications techniques des baies de disques NetApp comprennent le format, le nombre de disques par baie et les modules d'E/S ; cette documentation se trouve dans le tableau suivant. Pour plus d'informations, consultez la  https://www.netapp.com/data-storage/disk-shelves-storage-media/["Spécifications techniques des tiroirs disques et des supports de stockage NetApp"^] et la  https://hwu.netapp.com/["NetApp Hardware Universe"^].
