...
La figure suivante illustre le centre de données FlexPod pour FC avec Cisco MDS.
...
Pour plus d'informations sur la mise en œuvre d'ONTAP, voir https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["Tr-4684 : implémentation et configuration des SAN modernes avec NVMe"^].
