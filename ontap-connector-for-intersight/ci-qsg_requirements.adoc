...
NOTE: Veuillez vous référer à  https://intersight.com/help/saas/supported_systems/overview["Systèmes pris en charge par Cisco Intersight"^] pour connaître les exigences minimales des composants de calcul Cisco UCS et de la version UCSM.
...
Pour plus d'informations sur les fonctionnalités couvertes par les différents niveaux de licence, rendez-vous sur https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["Licence Infrastructure Services"^].
