...
image:flexpod-genomics-image6.png["Un schéma illustrant FlexPod pour la génomique avec Cisco UCS, Nexus, MDS et la connectivité NetApp AFF A700"]

Le diagramme suivant représente les détails du câblage FlexPod.

image:flexpod-genomics-image7.png["Un schéma illustrant FlexPod pour Genomics, montrant le câblage entre UCS, Nexus, NetApp AFF et les commutateurs MDS"]
