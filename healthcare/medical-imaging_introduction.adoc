...
Le système de santé, tel que nous le connaissons, repose sur les professionnels de santé (médecins, infirmiers, radiologues, techniciens de dispositifs médicaux, etc.) et les patients. À mesure que nous rapprochons les patients et les professionnels de santé, la localisation géographique devenant un simple point de données, il devient encore plus important que la plateforme sous-jacente soit disponible lorsque les professionnels de santé et les patients en ont besoin. La plateforme doit être à la fois performante et rentable sur le long terme. Dans leurs efforts pour réduire encore davantage les coûts des soins, les organisations de soins  https://www.cms.gov/priorities-innovation-key-concepts-accountable-care-accountable-care-organizations["Organismes de soins responsables"^]coordonnés (ACO) bénéficieraient d'une plateforme efficace.
...
* Les modalités mobiles, telles que les appareils de numérisation portables et sans fil (par exemple, les échographes portables de poche connectés à un téléphone), nécessitent une infrastructure réseau robuste avec un niveau de sécurité, de fiabilité et de latence conforme aux normes du ministère de la Défense américain, à la périphérie, au cœur du réseau et dans le cloud. https://www.netapp.com/blog/medical-imaging-cloud-disaster-recovery-meets-ai/["Une Data Fabric NetApp"^] fournit aux organisations cette capacité à grande échelle.
* Les nouvelles modalités d'imagerie ont des besoins de stockage exponentiels ; par exemple, la tomodensitométrie (CT) et l'imagerie par résonance magnétique (MRI) nécessitent quelques centaines de mégaoctets pour chaque modalité, tandis que les images de pathologie numérique (y compris l'imagerie de lames entières) peuvent atteindre plusieurs gigaoctets. FlexPod est conçu avec https://www.netapp.com/pdf.html?item=/media/16926-sb-flexpod-advantage-performance-agility-economics.pdf["performances, fiabilité et évolutivité sont des caractéristiques fondamentales"^].
...
image:medical-imaging_image2.png["Un diagramme illustrant le modèle de support coopératif FlexPod entre les clients, Cisco et NetApp"]
