...
image:flexpod-genomics-image2.png["Un diagramme illustrant l’unification des applications hospitalières sur FlexPod avec des protocoles, du stockage et une connectivité cloud"]
