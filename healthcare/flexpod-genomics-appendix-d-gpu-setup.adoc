...
+
image:flexpod-genomics-image18.png["Capture d'écran de l'onglet GPUs de l'inventaire de Cisco UCS Manager montrant une carte graphique P6 en mode Compute"]

+
image:flexpod-genomics-image19.png["Capture d'écran de Cisco UCS Manager affichant l'inventaire des GPU avec un UCSB-GPU-P6-R en mode Compute"]
...
. Cette commande installe le  https://docs.nvidia.com/vgpu/latest/grid-software-quick-start-guide/installing-configuring-vgpu-manager-guest-driver.html#installing-the-nvidia-virtual-gpu-manager-on-vmware-vsphere["NVIDIA vGPU Manager"^] dans ESXi.
+
....
...
+
image:flexpod-genomics-image20.png["Capture d'écran du vSphere Client montrant le périphérique graphique NVIDIA Tesla P6 configuré pour Shared Direct"]

+
image:flexpod-genomics-image21.png["Capture d'écran de la fenêtre « Modifier les paramètres du périphérique graphique » avec l'option « Direct partagé » sélectionnée et l'option « Redémarrer le serveur X.Org » cochée"]
...
+
image:flexpod-genomics-image22.png["Capture d'écran des options de démarrage de la machine virtuelle vCenter montrant le firmware EFI et le démarrage sécurisé désactivés"]
...
+
image:flexpod-genomics-image23.png["Une capture d'écran montrant la section avancée « Modifier les paramètres » de vCenter avec un lien « Modifier la configuration »"]

+
image:flexpod-genomics-image24.png["Capture d'écran de la boîte de dialogue Paramètres de configuration listant pciPassthru.64bitMMIOSizeGB et pciPassthru.use64bitMMIO"]
...
+
image:flexpod-genomics-image25.png["Capture d'écran de vCenter Edit Settings montrant le profil NVIDIA GRID vGPU grid_p6-16c sélectionné pour un périphérique PCI"]
...
+
image:flexpod-genomics-image26.png["Capture d'écran de la page « Clients sous licence » du serveur de licences NVIDIA affichant un client Ethernet virtuel"]
