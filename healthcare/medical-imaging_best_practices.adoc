...
image:medical-imaging_image8.png["Un schéma montrant les nœuds AFF A300 avec des ifgrp a0a, des VLAN et des LIF NFS et iSCSI"]
...
* Utilisez la technologie de réplication basée sur les baies de stockage NetApp appelée  https://www.netapp.com/pdf.html?item=/media/17229-tr4015.pdf["SnapMirror"^] au lieu de la réplication basée sur vSphere.
