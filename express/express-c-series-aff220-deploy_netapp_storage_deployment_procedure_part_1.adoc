...
+
image:express-c-series-aff220-deploy_image6.png["Capture d'écran des champs de configuration du cluster de l'assistant de configuration de System Manager pour deux nœuds de paire haute disponibilité et des licences"]
...
+
image:express-c-series-aff220-deploy_image7.png["Capture d'écran de la configuration de OnCommand System Manager Support avec les champs AutoSupport et de notification d'événements"]
