...
image:express-c-series-c190-design_image1.png["Un diagramme qui compare les déploiements FlexPod Express par département aux charges de travail critiques des centres de données FlexPod"]
...
image:express-c-series-c190-design_image2.png["Un schéma illustrant les options matérielles de stockage, de commutateur et de serveur FlexPod Express"]
...
image:express-c-series-c190-design_image3.png["Un schéma illustrant les commutateurs FlexPod Express, les serveurs C220 M5 et les connexions de stockage AFF C190"]
