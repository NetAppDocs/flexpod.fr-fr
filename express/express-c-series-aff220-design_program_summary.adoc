...
image:express-c-series-aff220-design_image2.png["Un diagramme illustrant les plateformes FlexPod Express, Datacenter et Select, ainsi que leurs déploiements et composants cibles"]
