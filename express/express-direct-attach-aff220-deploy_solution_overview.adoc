...
image:express-direct-attach-aff220-deploy_image2.png["Un diagramme qui compare les solutions FlexPod Express, FlexPod Datacenter et FlexPod Select"]
...
image:express-direct-attach-aff220-deploy_image3.png["Un schéma illustrant les serveurs FlexPod Express, les commutateurs Nexus et le câblage du stockage AFF pour la gestion, les données, l’IP, l’interconnexion de cluster et les réseaux homologues vPC."]
