...
+
image:express-c-series-c190-deploy_image34.png["Capture d'écran de la page du contrat de licence utilisateur final de l'installateur de l'appliance vCenter Server, avec l'acceptation sélectionnée"]

. Sélectionnez Embedded Platform Services Controller comme type de déploiement.
+
image:express-c-series-c190-deploy_image35.png["Capture d'écran de la page de type de déploiement de l'installateur vCenter Server Appliance avec l'option Embedded Platform Services Controller sélectionnée"]
...
+
image:express-c-series-c190-deploy_image36.png["Capture d'écran du formulaire cible de déploiement de l'appliance vCenter Server Installer avec les informations d'identification de l'hôte ESXi"]
...
+
image:express-c-series-c190-deploy_image37.png["Capture d'écran de la page « Set up appliance VM » de l'installateur vCenter Server Appliance, avec les champs « Nom de la machine virtuelle » et « Mot de passe root »."]

. Choisissez la taille de déploiement qui correspond le mieux à votre environnement. Cliquez sur Suivant.
+
image:express-c-series-c190-deploy_image38.png["Capture d'écran de la page de sélection de la taille de déploiement de l'installateur de l'appliance vCenter Server, avec l'option « Tiny » sélectionnée"]
...
+
image:express-c-series-c190-deploy_image39.png["Capture d'écran de la page de configuration des paramètres réseau de l'installateur de l'appliance vCenter Server, avec MGMT-Network sélectionné"]

. Passez en revue les paramètres de l'étape 1 avant de commencer le déploiement de l'appliance.
+
image:express-c-series-c190-deploy_image40.png["Capture d'écran de la page de vérification des paramètres de l'étape 1 du programme d'installation de l'appliance vCenter Server."]
...
+
image:express-c-series-c190-deploy_image41.png["Capture d'écran de la page d'introduction de l'étape 2 du programme d'installation de l'appliance vCenter Server avec un bouton Suivant"]
...
+
image:express-c-series-c190-deploy_image42.png["Capture d'écran de l'installateur de l'appliance vCenter Server, configuration SSO de l'étape 2 avec un nouveau domaine SSO sélectionné"]
...
+
image:express-c-series-c190-deploy_image43.png["Capture d'écran de la page de configuration CEIP de l'installateur de l'appliance vCenter Server avec l'option CEIP sélectionnée"]
...
+
image:express-c-series-c190-deploy_image44.png["Capture d'écran d'un avertissement du programme d'installation de l'appliance serveur vCenter indiquant que l'installation ne peut être ni mise en pause ni arrêtée, avec les boutons Annuler et OK"]
