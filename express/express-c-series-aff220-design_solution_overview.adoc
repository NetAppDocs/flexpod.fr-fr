...
image:express-c-series-aff220-design_image3.png["Un diagramme illustrant les familles de matériels de stockage, de commutation et de calcul FlexPod Express avec leurs options de configuration"]
...
image:express-c-series-aff220-design_image4.png["Un schéma illustrant la connectivité des commutateurs Cisco Nexus 3172P, des serveurs UCS C220 M5 et du stockage AFF A220"]
