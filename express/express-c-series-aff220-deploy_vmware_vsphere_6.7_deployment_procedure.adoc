...
+
image:express-c-series-aff220-deploy_image21.png["Capture d'écran de la page BIOS du serveur Cisco CIMC avec le lien « Launch KVM » dans le menu supérieur"]
...
=== Téléchargez l'image personnalisée Cisco ESXi 6.7

. Accédez à la  https://support.broadcom.com/group/ecx/downloads["site de téléchargement du portail d'assistance Broadcom"^] pour les ISO personnalisés.
...
+
image:express-c-series-aff220-deploy_image22.png["Capture d'écran de l'installateur ESXi sélectionnant un périphérique de stockage NETAPP LUN C-Mode d'une capacité de 15,00 Gio"]
...
+
image:express-c-series-aff220-deploy_image23.png["Capture d'écran du menu des adaptateurs réseau ESXi avec vmnic0 et vmnic1 sélectionnés pour vSwitch0"]
...
+
image:express-c-series-aff220-deploy_image24.png["Capture d'écran de l'onglet Commutateurs virtuels du réseau ESXi montrant vSwitch0 et iScsiBootvSwitch"]
...
** Cliquez sur Créer .
+
image:express-c-series-aff220-deploy_image25.png["Capture d'écran du formulaire « Ajouter une carte réseau VMkernel » configurant iScsiBootPG-B avec des paramètres IPv4 statiques et une MTU 9000"]
...
+
image:express-c-series-aff220-deploy_image26.png["Capture d'écran de la page des adaptateurs de stockage VMware ESXi avec l'adaptateur logiciel iSCSI vmhba64 sélectionné"]

. Sous cibles dynamiques, cliquez sur Ajouter une cible dynamique.
+
image:express-c-series-aff220-deploy_image27.png["Capture d'écran de la boîte de dialogue Configurer iSCSI avec l'option Ajouter une cible dynamique sous Cibles dynamiques"]
...
+
image:express-c-series-aff220-deploy_image28.png["Une capture d'écran montrant quatre adresses IP cibles dynamiques iSCSI, chacune utilisant le port 3260"]
...
+
image:express-c-series-aff220-deploy_image29.png["Capture d'écran de la page vSwitch0 de VMware ESXi montrant MTU 1500 et deux adaptateurs physiques actifs"]
...
+
image:express-c-series-aff220-deploy_image30.png["Capture d'écran de la page Réseau ESXi avec l'onglet Groupes de ports sélectionné et l'option Ajouter un groupe de ports disponible"]
...
+
image:express-c-series-aff220-deploy_image31.png["Capture d'écran de l'onglet Cartes réseau VMkernel du réseau ESXi listant les adaptateurs vmk0 et vmk1"]
...
** Cliquez sur Créer .
+
image:express-c-series-aff220-deploy_image32.png["Capture d'écran du formulaire « Ajouter une carte réseau VMkernel » configurant le groupe de ports NFS-Network avec des paramètres IPv4 statiques"]
...
+
image:express-c-series-aff220-deploy_image33.png["Capture d'écran de la boîte de dialogue Ajouter une carte réseau VMkernel avec les paramètres IPv4 statiques et vMotion sélectionné"]
...
+
image:express-c-series-aff220-deploy_image34.png["Capture d'écran de la page Stockage VMware ESXi avec le bouton Nouveau datastore visible"]

. Sélectionnez Mount NFS datastore.
+
image:express-c-series-aff220-deploy_image35.png["Capture d'écran de l'assistant Nouveau datastore avec l'option « Monter un datastore NFS » sélectionnée comme type de création"]
...
+
image:express-c-series-aff220-deploy_image36.png["Capture d'écran de la page « Heure et date système » d'ESXi affichant l'état du client NTP et des serveurs NTP"]
...
+
image:express-c-series-aff220-deploy_image37.png["Capture d'écran de la boîte de dialogue Modifier la configuration de l'heure avec NTP activé et un serveur NTP saisi"]
...
+
image:express-c-series-aff220-deploy_image38.png["Capture d'écran de la page VMware ESXi Manage System Swap avec les paramètres de swap affichés"]

. Cliquez sur Modifier les paramètres. Sélectionnez infra_swap dans les options datastore.
+
image:express-c-series-aff220-deploy_image39.png["Capture d'écran de la boîte de dialogue Modifier la configuration du swap avec infra_swap sélectionné comme datastore et les boutons Enregistrer et Annuler"]
...
+
image:express-c-series-aff220-deploy_image40.png["Un terminal affiche l'installation réussie du plug-in NFS VIB NetApp et un message indiquant qu'un redémarrage est nécessaire"]
