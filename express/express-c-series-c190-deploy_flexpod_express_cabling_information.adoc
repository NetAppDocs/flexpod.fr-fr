...
image:express-c-series-c190-deploy_image3.png["Un schéma montrant les vues arrière de deux commutateurs Nexus, de deux serveurs Cisco UCS et de contrôleurs AFF C190"]
