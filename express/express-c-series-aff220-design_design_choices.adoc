...
Pour plus d'informations sur le système matériel AFF A220, consultez le https://www.netapp.com/aff-a-series/["Page d'accueil de AFF A-Series"^].
...
image:express-c-series-aff220-design_image5.png["Un diagramme montrant plusieurs blocs logiques de 4 Ko compactés en un seul bloc physique de 4 Ko"]
...
image:express-c-series-aff220-design_image6.png["Un schéma montrant les disques partitionnés en partitions racine, Controller 1 et Controller 2"]

Voici quelques fonctionnalités clés qui complètent la solution FlexPod Express. Pour plus de détails sur les fonctionnalités supplémentaires et la fonctionnalité d’ONTAP 9.4, consultez la  https://www.netapp.com/pdf.html?item=/media/7413-ds-3231-ontap-unified-data-storage-management.pdf["Fiche technique sur le logiciel de gestion des données ONTAP 9"^]. Consultez également la NetApp http://docs.netapp.com/ontap-9/index.jsp["Centre de documentation ONTAP 9"^], qui a été mise à jour pour inclure ONTAP 9.4.
...
image:express-c-series-aff220-design_image7.png["Capture d'écran montrant la vue de face d'un commutateur Cisco Nexus 3172 avec des ports réseau"]
...
image:express-c-series-aff220-design_image8.png["Vue de face d’un serveur en rack Cisco UCS C220 M5 avec deux baies de disques et la marque Cisco"]
...
image:express-c-series-aff220-design_image9.png["Une carte adaptateur Cisco UCS VIC 1387 avec deux ports QSFP+ et un ventilateur de refroidissement"]
...
image:express-c-series-aff220-design_image10.png["Photographie d'un module adaptateur Cisco CVR-QSFP-SFP10G QSFP-vers-SFP"]
