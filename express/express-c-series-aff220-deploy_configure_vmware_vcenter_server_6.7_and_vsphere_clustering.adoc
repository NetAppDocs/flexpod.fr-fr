...
. Cliquez sur OK.
+
image:express-c-series-aff220-deploy_image49.png["Capture d'écran de la boîte de dialogue Nouveau cluster avec DRS et vSphere HA activés pour le cluster Tiger3"]
...
+
image:express-c-series-aff220-deploy_image50.png["Capture d'écran du vSphere Web Client montrant le menu Actions du cluster FlexPod avec l'option Ajouter un hôte sélectionnée"]
