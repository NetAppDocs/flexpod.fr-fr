...
image:express-c-series-aff220-deploy_image5.png["Un schéma montrant les commutateurs Cisco Nexus, les serveurs Cisco UCS et les contrôleurs NetApp AFF A220 avec les ports 10GbE mis en évidence"]
