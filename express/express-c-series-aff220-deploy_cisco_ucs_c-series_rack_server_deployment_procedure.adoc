...
+
image:express-c-series-aff220-deploy_image8.png["Capture d'écran de l'écran de démarrage d'un serveur Cisco invitant l'utilisateur à appuyer sur F8 pour la configuration CIMC"]
...
*** Aucune : [x]
+
image:express-c-series-aff220-deploy_image9.png["Capture d'écran des propriétés de la carte réseau Cisco IMC avec les paramètres IPv4 et sans redondance de carte réseau sélectionnée"]
...
+
image:express-c-series-aff220-deploy_image10.png["Capture d'écran de l'utilitaire de configuration Cisco IMC affichant les propriétés communes et les paramètres de port"]
...
+
image:express-c-series-aff220-deploy_image11.png["Capture d'écran des paramètres du BIOS du Cisco Integrated Management Controller avec l'option « Configurer l'ordre de démarrage » sélectionnée"]
...
+
image:express-c-series-aff220-deploy_image12.png["Capture d'écran de la configuration avancée de l'ordre de démarrage avec KVM-MAPPED-DVD, iSCSI-A et iSCSI-B activés"]
...
+
image:express-c-series-aff220-deploy_image13.png["Capture d'écran montrant les paramètres du BIOS CIMC avec les Option ROM des emplacements PCIe 1 et 2 désactivées"]
...
+
image:express-c-series-aff220-deploy_image14.png["Capture d'écran montrant les paramètres iSCSI-vNIC-A avec MTU 9000, VLAN 3439, mode trunk et démarrage PXE activé"]
...
+
image:express-c-series-aff220-deploy_image15.png["Une capture d'écran montrant iSCSI-vNIC-A sélectionné avec les propriétés de démarrage iSCSI développées dans l'onglet vNICs"]
...
+
image:express-c-series-aff220-deploy_image16.png["Capture d'écran des propriétés de démarrage iSCSI de Cisco UCS affichant le nom de l'initiateur, l'adresse IP, le masque de sous-réseau et les champs de passerelle"]
...
+
image:express-c-series-aff220-deploy_image17.png["Capture d'écran montrant les paramètres de l'initiateur iSCSI vNIC avec les cibles NetApp primaire et secondaire"]
...
+
image:express-c-series-aff220-deploy_image18.png["Une capture d'écran de l'onglet vNICs de Cisco VIC répertoriant eth0, eth1 et deux vNIC iSCSI"]

. Sélectionnez eth0, puis cliquez sur Propriétés.
. Définissez la MTU sur 9000. Cliquez sur Save Changes.
+
image:express-c-series-aff220-deploy_image19.png["Capture d'écran des propriétés de l'interface réseau virtuelle Cisco VIC eth0 avec le champ MTU défini sur 9000"]

. Répétez les étapes 3 et 4 pour eth1, en vérifiant que le port de liaison montante est défini sur `1` pour eth1.
+
image:express-c-series-aff220-deploy_image20.png["Capture d'écran montrant l'onglet vNIC avec eth0 et eth1 MTU configurés à 9000 et les ports de liaison montante 0 et 1"]
