...
+
image:express-c-series-c190-deploy_image5.png["Une capture d'écran montrant l'écran de démarrage d'un serveur Cisco invitant l'utilisateur à appuyer sur F8 pour la configuration CIMC"]
...
+
image:express-c-series-c190-deploy_image6.png["Capture d'écran de l’utilitaire de configuration Cisco IMC, propriétés de la carte réseau avec carte réseau dédiée et sans redondance sélectionnée"]
...
+
image:express-c-series-c190-deploy_image7.png["Capture d'écran de la page de configuration de l'ordre de démarrage du BIOS du Cisco Integrated Management Controller"]
...
+
image:express-c-series-c190-deploy_image8.png["Capture d'écran de la configuration avancée de l'ordre de démarrage avec KVM-MAPPED-DVD, iSCSI-A et iSCSI-B activés"]
...
+
image:express-c-series-c190-deploy_image9.png["Capture d'écran montrant les paramètres du BIOS CIMC avec les Option ROM des emplacements PCIe 1 et 2 désactivées"]
...
+
image:express-c-series-c190-deploy_image10.png["Capture d'écran de l'onglet Général de la carte adaptateur MLOM Cisco Integrated Management Controller avec l'option Port Channel décochée"]
...
+
image:express-c-series-c190-deploy_image11.png["Capture d'écran affichant les paramètres généraux de l'interface réseau virtuelle iSCSI eth1 avec le VLAN 3439 et le port de liaison montante 1"]



. Sélectionnez vNIC eth1 sur la gauche.
+
image:express-c-series-c190-deploy_image12.png["Capture d'écran montrant les paramètres de l'initiateur des propriétés de démarrage iSCSI pour le vNIC eth1"]
...
+
image:express-c-series-c190-deploy_image13.png["Capture d'écran des propriétés de démarrage iSCSI avec les détails de l'initiateur, de la cible principale et de la cible secondaire"]
...
+
image:express-c-series-c190-deploy_image14.png["Capture d'écran montrant les propriétés de démarrage iSCSI pour la vNIC eth3 avec les paramètres de l'initiateur et de la cible"]
...
+
image:express-c-series-c190-deploy_image15.png["Capture d'écran des propriétés de l'interface réseau virtuelle eth0 du Cisco Integrated Management Controller avec une MTU de 9000 et le VLAN par défaut 2"]

. Répétez les étapes 3 et 4 pour eth1, en vérifiant que le port uplink est défini sur 1 pour eth1.
+
image:express-c-series-c190-deploy_image16.png["Capture d'écran du Cisco Integrated Management Controller listant les vNIC eth0 à eth3 avec les paramètres MTU, le port de liaison montante et les paramètres VLAN"]
