...
image:express-c-series-c190-design_image4.png["Un schéma montrant les vues arrière de deux contrôleurs AFF C190 avec ports UTA 2 pour modules SFP+"]

La figure suivante illustre les ports 10GBASE-T pour la connexion via des câbles Ethernet RJ-45 traditionnels.

image:express-c-series-c190-design_image5.png["Un schéma illustrant le panneau arrière d'un système AFF C190 avec des ports RJ-45 10GBASE-T"]
...
Pour obtenir des informations complètes sur le système matériel AFF C190, consultez le https://docs.netapp.com/us-en/ontap-systems/c190/install-setup.html["NetApp Documentation AFF C190"^].
...
image:express-c-series-c190-design_image6.png["Un diagramme montrant plusieurs blocs logiques de 4 Ko compactés en un seul bloc physique de 4 Ko"]
...
image:express-c-series-c190-design_image7.png["Vue de face d'un commutateur Cisco Nexus 31108PC-V doté de 48 ports SFP+ et de six ports QSFP28"]
...
image:express-c-series-c190-design_image8.png["Vue de face d’un serveur en rack Cisco UCS C220 M5 avec deux baies de disques et la marque Cisco"]
...
image:express-c-series-c190-design_image9.png["Capture d'écran de l'adaptateur Cisco UCS VIC 1457 avec quatre ports SFP28 et un ventilateur de refroidissement"]
...
image:express-c-series-c190-design_image10.png["Un schéma montrant quatre vNIC connectées à FlexPod et aux vSwitches de démarrage iSCSI sur un hôte VMware ESXi 6.7 U2"]
