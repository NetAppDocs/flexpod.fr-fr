...
image:express-c-series-aff220-deploy_image3.png["Un diagramme qui compare les solutions, les cibles et les composants d'infrastructure FlexPod Express, Datacenter et Select"]
...
image:express-c-series-aff220-deploy_image4.png["Un schéma illustrant la connectivité des commutateurs Cisco Nexus 3172P, des serveurs UCS C220 M5 et du stockage AFF A220"]
