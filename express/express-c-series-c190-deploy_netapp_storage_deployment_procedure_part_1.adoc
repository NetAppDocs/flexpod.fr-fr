...
+
image:express-c-series-c190-deploy_image4.png["Capture d'écran de la configuration de OnCommand System Manager Support avec les champs AutoSupport et de notification d'événements"]
...
link:express-c-series-c190-deploy_deploy_cisco_ucs_c-series_rack_server.html["Ensuite, déployez le serveur rack Cisco UCS C-Series."]
