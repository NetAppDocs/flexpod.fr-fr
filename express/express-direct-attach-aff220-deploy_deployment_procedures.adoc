...
Suivez les procédures d'installation physique des contrôleurs dans le https://docs.netapp.com/us-en/ontap-systems/a220/install-setup.html["Documentation AFF A220"^].
...
+
image:express-direct-attach-aff220-deploy_image7.png["Capture d'écran de la boîte de dialogue « Créer un bloc d'adresses IPv4 » avec les champs Adresse IP, sous-réseau, passerelle et DNS"]
...
+
image:express-direct-attach-aff220-deploy_image8.png["Capture d'écran de la boîte de dialogue Ajouter un serveur NTP avec NTP Server défini sur 10.1.156.4"]

. Cliquez sur Ajouter un serveur NTP.
. Entrez `<switch-b-ntp-ip>` `or <Nexus-B-mgmt-IP>` Puis cliquez sur OK. Cliquez sur OK dans la confirmation.
+
image:express-direct-attach-aff220-deploy_image9.png["Capture d'écran des paramètres NTP de Cisco UCS Manager avec deux serveurs NTP listés et le fuseau horaire America/New_York sélectionné"]
...
+
image:express-direct-attach-aff220-deploy_image10.png["Une capture d'écran montrant les ports Ethernet Fabric Interconnect A avec les rôles de liaison montante et de stockage d'appliance configurés"]
...
. Dans l'onglet ports Ethernet, vérifiez que les ports ont été correctement configurés dans la colonne rôle si. Si des serveurs C-Series de port ont été configurés sur le port d'évolutivité, cliquez dessus pour vérifier la connectivité des ports.
+
image:express-direct-attach-aff220-deploy_image11.png["Capture d'écran montrant les ports Ethernet Fabric Interconnect B avec les rôles de réseau et de stockage d'appliance configurés"]
...
. Cliquez sur Suivant.
+
image:express-direct-attach-aff220-deploy_image12.png["Capture d'écran de la boîte de dialogue Créer un canal de port avec l'ID 1 et le nom vPC-13-Nexus saisis"]
...
+
image:express-direct-attach-aff220-deploy_image13.jpeg["Capture d'écran de la boîte de dialogue Create VLANs avec NFS-VLAN et VLAN ID 3170 saisis"]
...
. Cliquez sur OK, puis à nouveau sur OK pour créer le VLAN.
+
image:express-direct-attach-aff220-deploy_image14.png["Une capture d'écran qui montre le tableau des VLAN dans Cisco UCS Manager avec les noms et les identifiants des VLAN"]
...
+
image:express-direct-attach-aff220-deploy_image15.png["Une capture d'écran montrant la stratégie de contrôle réseau Enable_CDP avec CDP et LLDP activés en émission et en réception"]
...
+
image:express-direct-attach-aff220-deploy_image16.png["Capture d'écran des propriétés de l'interface 1/3 de l'appliance avec CDP activé et les VLANs de stockage sélectionnés"]
...
+
image:express-direct-attach-aff220-deploy_image17.png["Capture d'écran des paramètres VLAN de l'interface 1/3 de l'appliance avec les VLAN iSCSI-B, NFS et natifs sélectionnés"]
...
+
image:express-direct-attach-aff220-deploy_image18.png["Capture d'écran des paramètres de classe système QoS de Cisco UCS Manager avec le MTU Best Effort défini sur 9216"]
...
+
image:express-direct-attach-aff220-deploy_image19.png["Capture d'écran de la boîte de dialogue Modifier les versions du package avec Blade Package 4.0(1b)B sélectionné"]
...
+
image:express-direct-attach-aff220-deploy_image20.png["Capture d'écran de la boîte de dialogue « Créer un bloc d'adresses MAC » avec l'adresse MAC 00:25:B5:32:0A:00 et une taille de 64"]
...
+
image:express-direct-attach-aff220-deploy_image21.png["Capture d'écran de la boîte de dialogue « Create a Block of IQN Suffixes » avec le suffixe ucs-host, From 1, et Size 16"]
...
+
image:express-direct-attach-aff220-deploy_image22.png["Capture d'écran de la boîte de dialogue Créer une stratégie de contrôle réseau avec CDP et LLDP activés"]
...
+
image:express-direct-attach-aff220-deploy_image23.png["Capture d'écran de la boîte de dialogue Create Power Control Policy avec No-Power-Cap et No Cap sélectionnés"]
...
+
image:express-direct-attach-aff220-deploy_image24.png["Capture d'écran de la boîte de dialogue « Create CPU/Cores Qualification » de Cisco UCS Manager, avec l'architecture du processeur Xeon et le champ CPU PID."]
...
+
image:express-direct-attach-aff220-deploy_image25.png["Capture d'écran de la boîte de dialogue Create BIOS Policy avec le nom VM-Host et l'option Consistent Device Naming activés"]
...
+
image:express-direct-attach-aff220-deploy_image26.png["Capture d'écran de l'onglet Créer une stratégie BIOS Processeur avec l'état C du processeur et C1E désactivés"]
...
+
image:express-direct-attach-aff220-deploy_image27.png["Capture d'écran montrant les options du processeur dans le BIOS, avec Energy Performance et DRAM Clock Throttling réglés sur performance"]
...
+
image:express-direct-attach-aff220-deploy_image28.png["Capture d'écran de la page Créer une stratégie BIOS Mémoire RAS avec le mode LV DDR réglé sur Performance Mode"]
...
+
image:express-direct-attach-aff220-deploy_image29.png["Capture d'écran de la politique de maintenance par défaut de Cisco UCS Manager avec les options « User Ack » et « On Next Boot » sélectionnées"]
...
. Cliquez sur OK.
+
image:express-direct-attach-aff220-deploy_image30.png["Capture d'écran des propriétés du modèle vNIC de Cisco UCS Manager pour vNIC_Template_A sur Fabric A"]
...
. Cliquez sur OK.
+
image:express-direct-attach-aff220-deploy_image31.png["Capture d'écran des paramètres du modèle vNIC B de Cisco UCS Manager avec Fabric B, MTU 9000 et MAC Pool B sélectionnés"]
...
. Cliquez sur OK.
+
image:express-direct-attach-aff220-deploy_image32.png["Capture d'écran du modèle vNIC Site_01_iSCSI-A avec Fabric A, MTU 9000 et MAC Pool A56/64 sélectionné"]
...
. Cliquez sur OK.
+
image:express-direct-attach-aff220-deploy_image33.png["Capture d'écran des paramètres du modèle vNIC Site_01_iSCSI-B de Cisco UCS Manager pour Fabric B avec MTU 9000"]
...
+
image:express-direct-attach-aff220-deploy_image34.png["Capture d'écran affichant la boîte de dialogue Modifier la carte réseau virtuelle (vNIC) pour Site-01-vNIC-A utilisant vNIC_Template_A et la stratégie d'adaptateur VMWare"]
...
+
image:express-direct-attach-aff220-deploy_image35.png["Capture d'écran de la boîte de dialogue Modifier la carte réseau virtuelle iSCSI pour Site-01-iSCSI-A avec les paramètres VLAN et d'adresse MAC"]
...
. Cliquez sur Save Changes.
+
image:express-direct-attach-aff220-deploy_image36.png["Capture d'écran de la stratégie de connectivité LAN Site-01-iSCSIBoot avec deux vNIC iSCSI listées"]
...
+
Cette image ISO de VMware ESXi 6.7U1 peut être téléchargée depuis https://support.broadcom.com/group/ecx/downloads["portail d'assistance Broadcom"^].
...
+
image:express-direct-attach-aff220-deploy_image37.png["Capture d'écran de la boîte de dialogue Créer vMedia Mount configurée avec un fichier ISO d'installation ESXi distant via HTTP et son chemin d'accès"]
...
+
image:express-direct-attach-aff220-deploy_image38.png["Capture d'écran de la stratégie de démarrage Cisco UCS Manager Site-01-Fabric-A avec deux entrées de démarrage iSCSI configurées"]
...
+
image:express-direct-attach-aff220-deploy_image39.png["Capture d'écran de l'assistant de création de modèle de profil de service avec les champs nom, mise à jour du modèle et pool d'UUID"]
...
+
image:express-direct-attach-aff220-deploy_image40.png["Capture d'écran des paramètres réseau du modèle de profil de service Create Service Profile Template avec la connectivité iSCSI-Boot et IQN_Pool sélectionné"]
...
+
image:express-direct-attach-aff220-deploy_image41.png["Capture d'écran de la page « Ordre de démarrage du serveur du modèle de profil de service » avec Boot-Fabric-A sélectionné"]
...
+
image:express-direct-attach-aff220-deploy_image42.png["Capture d'écran de la sortie de la commande iscsi show listant un IQN de cible Infra-SVM, un alias et un état « up »"]

. Entrez l'adresse IP de `iscsi_lif_02a` Pour le champ adresse IPv4.
+
image:express-direct-attach-aff220-deploy_image43.png["Capture d'écran de la boîte de dialogue « Créer une cible statique iSCSI » avec l'adresse IPv4 192.168.10.62 saisie"]
...
+
image:express-direct-attach-aff220-deploy_image44.png["Capture d'écran de la boîte de dialogue Créer une cible statique iSCSI avec l'adresse IPv4 192.168.10.61 et l'ID LUN 0"]

. Cliquez sur OK pour ajouter la cible statique iSCSI.
+
image:express-direct-attach-aff220-deploy_image45.png["Capture d'écran de la boîte de dialogue « Définir les paramètres de démarrage iSCSI » avec les interfaces cibles statiques iSCSI sélectionnées"]
...
+
image:express-direct-attach-aff220-deploy_image46.png["Capture d'écran de la boîte de dialogue Create iSCSI Static Target avec l'adresse IPv4 définie sur 192.168.20.62"]
...
+
image:express-direct-attach-aff220-deploy_image47.png["Capture d'écran de la boîte de dialogue Créer une cible statique iSCSI avec l'adresse IPv4 192.168.20.61 et l'ID LUN 0"]

. Cliquez sur OK pour ajouter la cible statique iSCSI.
+
image:express-direct-attach-aff220-deploy_image48.png["Une capture d'écran qui montre deux interfaces cibles statiques iSCSI sélectionnées dans Définir les paramètres de démarrage iSCSI"]
...
+
image:express-direct-attach-aff220-deploy_image49.png["Capture d'écran de l'étape « Créer une stratégie de maintenance de modèle de profil de service » avec la stratégie par défaut sélectionnée"]
...
+
image:express-direct-attach-aff220-deploy_image50.png["Capture d'écran de la création d'un modèle de profil de service avec affectation de serveur à l'Infra-Pool, état d'alimentation « Hors tension » et package de firmware par défaut sélectionnés"]
...
+
image:express-direct-attach-aff220-deploy_image51.png["Capture d'écran de la page « Stratégies opérationnelles du modèle de profil de service » avec « BIOS VM-Host » et « No-Power-Cap » sélectionnés"]
...
+
image:express-direct-attach-aff220-deploy_image52.png["Capture d'écran de la boîte de dialogue « Créer des profils de service à partir d'un modèle » avec le préfixe Site-01-Infra-0, le numéro 2 et l'organisation racine"]
...
. Connectez-vous au site de téléchargement du portail d'assistance Broadcom : https://support.broadcom.com/group/ecx/downloads["https://support.broadcom.com/group/ecx/downloads"^].
. Vous aurez besoin d'un identifiant et d'un mot de passe Broadcom. Recherchez les images ISO personnalisées de l'hyperviseur VMware vSphere (ESXi).
. Téléchargez l'image personnalisée Cisco pour le CD d'installation ESXi 6.7U1.
...
. Appuyez sur entrée.
+
image:express-direct-attach-aff220-deploy_image53.png["Capture d'écran de l'écran des adaptateurs réseau ESXi avec vmnic0 et vmnic1 sélectionnés et connectés"]
...
+
image:express-direct-attach-aff220-deploy_image54.png["Capture d'écran montrant les détails et la topologie du vSwitch0 avec les adaptateurs VMkernel et deux adaptateurs physiques"]
...
+
image:express-direct-attach-aff220-deploy_image55.png["Capture d'écran de l'onglet Cartes réseau VMkernel d'ESXi listant cinq adaptateurs VMkernel et leurs groupes de ports"]
...
+
image:express-direct-attach-aff220-deploy_image56.png["Capture d'écran de l'onglet Adaptateurs de stockage ESXi avec l'adaptateur logiciel iSCSI vmhba64 sélectionné"]
...
+
image:express-direct-attach-aff220-deploy_image57.png["Capture d'écran de la boîte de dialogue Configurer iSCSI montrant quatre cibles iSCSI dynamiques et statiques sur le port 3260"]
...
+
image:express-direct-attach-aff220-deploy_image58.png["Capture d'écran de l'assistant Nouveau datastore avec l'option « Monter un datastore NFS » sélectionnée comme type de création"]
...
.. Cliquez sur Suivant.
+
image:express-direct-attach-aff220-deploy_image59.png["Capture d'écran de la page « Fournir les détails du montage NFS » avec infra_datastore_1 et le serveur NFS 192.168.104.3"]
...
. Cliquez sur Terminer. Le datastore doit maintenant apparaître dans la liste datastore.
+
image:express-direct-attach-aff220-deploy_image60.jpeg["Capture d'écran de la liste des banques de données de stockage ESXi montrant infra_datastore_2 monté en tant que banque de données NFS"]
...
+
image:express-direct-attach-aff220-deploy_image61.png["Capture d'écran de la boîte de dialogue Modifier la configuration de l'heure avec NTP activé et deux adresses de serveur NTP saisies"]
...
+
image:express-direct-attach-aff220-deploy_image62.png["Capture d'écran de la page VMware ESXi Manage System Swap affichant les paramètres de swap et les paramètres de modification"]

. Cliquez sur Modifier les paramètres. Sélectionnez `infra_swap` Dans les options datastore.
+
image:express-direct-attach-aff220-deploy_image63.png["Capture d'écran de la boîte de dialogue Modifier la configuration du swap avec le datastore infra_swap sélectionné et les boutons Enregistrer et Annuler"]
...
+
image:express-direct-attach-aff220-deploy_image64.png["Capture d'écran du navigateur d'hôtes ESXi avec le bouton vCenter Server « Get » mis en évidence"]
...
+
image:express-direct-attach-aff220-deploy_image65.png["Capture d'écran de la page de sélection du type de déploiement de l'installateur vCenter Server Appliance, avec l'option « Embedded Platform Services Controller » sélectionnée"]
...
+
image:express-direct-attach-aff220-deploy_image66.png["Capture d'écran de la page cible de déploiement de l'appliance VCenter Server Appliance Installer avec les informations d'identification de l'hôte ESXi saisies"]
...
+
image:express-direct-attach-aff220-deploy_image67.png["Capture d'écran de la page « Set up appliance VM » de l'installateur vCenter Server Appliance, avec les champs « Nom de la machine virtuelle » et « Mot de passe root »."]

. Choisissez la taille de déploiement qui correspond le mieux à votre environnement. Cliquez sur Suivant.
+
image:express-direct-attach-aff220-deploy_image68.png["Capture d'écran de la page de sélection de la taille de déploiement de l'installateur de l'appliance vCenter Server, avec l'option « Tiny » sélectionnée"]

. Sélectionner `infra_datastore_1` datastore. Cliquez sur Suivant.
+
image:express-direct-attach-aff220-deploy_image69.png["Capture d'écran de la page de sélection du datastore de l'installateur de l'appliance vCenter Server, avec infra_datastore_1 répertorié parmi trois datastores"]
...
+
image:express-direct-attach-aff220-deploy_image70.png["Capture d'écran de la page de configuration des paramètres réseau de l'installateur de l'appliance vCenter Server avec les détails IPv4 statiques"]
...
+
image:express-direct-attach-aff220-deploy_image71.png["Capture d'écran montrant le déploiement réussi du serveur vCenter de l'étape 1 avec un bouton Continuer"]
...
. Cliquez sur OK.
+
image:express-direct-attach-aff220-deploy_image72.png["Capture d'écran de la boîte de dialogue Nouveau cluster avec DRS et vSphere HA activés pour le cluster Express"]
...
+
image:express-direct-attach-aff220-deploy_image73.png["Capture d'écran du menu Actions du client vSphere pour le cluster Express avec l'option Ajouter des hôtes sélectionnée"]
