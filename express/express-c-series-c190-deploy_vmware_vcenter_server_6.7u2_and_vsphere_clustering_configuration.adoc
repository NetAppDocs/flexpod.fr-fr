...
. Cliquez sur OK.
+
image:express-c-series-c190-deploy_image45.png["Capture d'écran de la boîte de dialogue Nouveau cluster avec DRS et vSphere HA activés et vSAN désactivé"]
...
+
image:express-c-series-c190-deploy_image46.png["Capture d'écran de l'assistant d'ajout d'hôtes du vSphere Client, avec un champ de saisie du FQDN de l'hôte et un bouton Suivant"]
...
. Connectez-vous à `https://<vCenter IP>:5480`, entrez root comme nom d'utilisateur et saisissez le mot de passe root.
...
+
image:express-c-series-c190-deploy_image47.png["Capture d'écran des Appliance Management Services avec VMware vSphere ESXi Dump Collector sélectionné et Démarrer disponible"]
...
+
image:express-c-series-c190-deploy_image48.png["Un terminal affichant les commandes de configuration de vidage mémoire ESXi et la vérification du serveur netdump"]
