...
image:express-c-series-c190-deploy_image1.png["Un diagramme qui montre les options des portefeuilles FlexPod Express et FlexPod Datacenter avec des cas d'utilisation"]
...
image:express-c-series-c190-deploy_image2.png["Un schéma illustrant les commutateurs FlexPod Express, les serveurs C220 M5 et les connexions de stockage AFF C190"]
