...
+
image:express-c-series-c190-deploy_image17.png["Capture d'écran de la page BIOS du serveur Cisco CIMC avec le lien « Launch KVM » dans le menu supérieur"]
...
+
image:express-c-series-c190-deploy_image18.png["Capture d'écran de l'installateur ESXi sélectionnant un périphérique de stockage NETAPP LUN C-Mode d'une capacité de 15,00 Gio"]
...
+
image:express-c-series-c190-deploy_image19.png["Capture d'écran de l'écran des adaptateurs réseau ESXi avec vmnic2 et vmnic4 sélectionnés pour la gestion du réseau"]
...
+
image:express-c-series-c190-deploy_image20.png["Capture d'écran de la page Réseau ESXi avec l'onglet Commutateurs virtuels affichant vSwitch0 et iScsiBootvSwitch"]
...
+
image:express-c-series-c190-deploy_image21.png["Capture d'écran des paramètres d'agrégation et de basculement iSCSIBootPG-A avec vmnic3 actif et vmnic5 inutilisé"]
...
+
image:express-c-series-c190-deploy_image22.png["Capture d'écran de l'onglet Adaptateurs de stockage ESXi avec l'adaptateur logiciel iSCSI vmhba64 sélectionné"]

. Sous cibles dynamiques, cliquez sur Ajouter une cible dynamique.
+
image:express-c-series-c190-deploy_image23.png["Capture d'écran montrant des cibles dynamiques iSCSI avec quatre adresses IP et le port 3260 configurés"]
...
+
image:express-c-series-c190-deploy_image24.png["Capture d'écran de quatre adresses cibles dynamiques iSCSI utilisant le port 3260 et le bouton Save Configuration"]
...
+
image:express-c-series-c190-deploy_image25.png["Capture d'écran de la page ESXi vSwitch0 montrant MTU 9000 et les adaptateurs vmnic2 et vmnic4 actifs"]
...
+
image:express-c-series-c190-deploy_image26.png["Capture d'écran de la page Réseau ESXi avec l'onglet Groupes de ports sélectionné et l'option Ajouter un groupe de ports disponible"]
...
+
image:express-c-series-c190-deploy_image27.png["Capture d'écran de l'onglet « Cartes réseau VMkernel » du réseau ESXi listant les interfaces vmk0 et vmk1"]
...
+
image:express-c-series-c190-deploy_image28.png["Capture d'écran de la boîte de dialogue Ajouter une carte réseau VMkernel avec les paramètres IPv4 statiques et vMotion sélectionné"]
...
+
image:express-c-series-c190-deploy_image29.png["Capture d'écran de la page Stockage VMware ESXi avec le bouton Nouveau datastore visible"]

. Sélectionnez Mount NFS datastore.
+
image:express-c-series-c190-deploy_image30.png["Capture d'écran de l'assistant Nouveau datastore avec l'option « Monter un datastore NFS » sélectionnée comme type de création"]
...
. Cliquez sur Enregistrer.
+
image:express-c-series-c190-deploy_image31.png["Capture d'écran montrant les paramètres de date et d'heure d'ESXi avec le service NTP en cours d'exécution et trois serveurs NTP"]
...
+
image:express-c-series-c190-deploy_image32.png["Capture d'écran de la page VMware ESXi Manage System Swap avec les paramètres de swap affichés"]

. Cliquez sur Modifier les paramètres. Sélectionnez `infra_swap` Dans les options datastore.
+
image:express-c-series-c190-deploy_image33.png["Capture d'écran de la boîte de dialogue Modifier la configuration du swap avec infra_swap sélectionné comme datastore et les boutons Enregistrer et Annuler"]
