...
image:flexpod-fips-image3.png["Un schéma illustrant le flux de données chiffrées en écriture et déchiffrées en lecture à travers le réseau, WAFL, RAID et le stockage avec un module cryptographique"]
...
image:flexpod-fips-image4.png["Un diagramme illustrant le chiffrement et le déchiffrement à travers les couches Réseau, WAFL, RAID et module cryptographique de Stockage"]
...
image:flexpod-fips-image5.png["Un diagramme illustrant la limite cryptographique d'ONTAP avec les composants key manager, cryptomod et cryptomod_fips"]
