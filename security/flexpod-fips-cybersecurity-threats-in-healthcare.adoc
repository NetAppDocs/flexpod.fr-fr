...
image:flexpod-fips-image2.png["Un diagramme montrant l'intégration d'applications d'entreprise reliant les systèmes cliniques et administratifs hospitaliers"]
