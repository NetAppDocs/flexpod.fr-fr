...
image:flexpod-fips-image6.png["Un schéma illustrant la conformité FIPS 140-2 de FlexPod pour les connexions de calcul, de réseau et de stockage dans le secteur de la santé"]
